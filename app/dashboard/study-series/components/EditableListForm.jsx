...
const SeriesEditableListForm = ({ items = [], type, studySeriesId }) => {
  ...
  const handleSave = async () => {
    try {
      setLoading(true);
      const result = await updateStudySeries(studySeriesId, { [type]: list });
...
export default SeriesEditableListForm;
