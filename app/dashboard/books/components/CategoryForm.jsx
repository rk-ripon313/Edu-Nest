...
import { updateABook, validateCategory } from "@/app/actions/boook.action";
...
const CategoryForm = ({ category, categories, bookId }) => {
  ...
  const onSubmit = async (values) => {
    try {
      ...
      if (result?.success) {
        toggleEdit();
        router.refresh();
        toast.success(result?.message || "Book Category has been updated.");
      } else {
